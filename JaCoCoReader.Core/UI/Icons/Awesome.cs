...
namespace JaCoCoReader.Core.UI.Icons
{
    /// <summary>
    ...
    public static class Awesome
    {
        ...
        /// </summary>
        public static readonly FontFamily FontAwesomeFontFamily = new FontFamily(new Uri("pack://application:,,,/JaCoCoReader.Core;component/UI/Icons/FontAwesome.otf"), "./#FontAwesome");
